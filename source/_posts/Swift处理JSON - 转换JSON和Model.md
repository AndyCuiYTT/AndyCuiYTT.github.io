...
---
# 背景
&emsp;&emsp;很多时候我们再服务端请求下来的数据都是[JSON](https://baike.baidu.com/item/JSON/2462549)格式，我们需要将这些数据展示在UI界面。我们一般都会先将JSON转化为数据模型或字典进行使用。
&emsp;&emsp;为了更快的开发我们时常会用到一些开源库，其中JSON解析的库必不可少，在OC开发中我们常用的JSON解析库如[MJExtension](https://github.com/CoderMJLee/MJExtension)，[JSONModel](https://github.com/jsonmodel/jsonmodel)等,这些库基本都是利用runtime实现读取属性并利用kvc赋值的。在swift中由于runtime的局限性，产生了一些通过反射等机制实现的库，比如[SwiftyJSON](https://github.com/SwiftyJSON/SwiftyJSON)，[ObjectMapper](https://github.com/Hearst-DD/ObjectMapper)，[HandyJSON](https://github.com/alibaba/handyjson)等，而 HandyJSON 是其中使用最舒服的一个库，本文将介绍用  HandyJSON 来进行Model和JSON间的互相转换。
...
* [iOS Code Generator](https://github.com/banxi1988/iOSCodeGenerator/blob/master/README.md)
* [D3Json](https://github.com/mozhenhau/D3Json)
* [JSONUtilities](https://github.com/lucianomarisi/JSONUtilities)
